...
const IncomeForm = ({
  ...
  const { addIncome } = useContext(DebtContext);

  const submitForm = () => {
    console.log("Adding", {...formFields, date: value,});
    addIncome({...formFields, date: value});
    closeAction();
  };
  return (
    <div
    ...
    >
      ...
      <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <InputField
          ...
          placeholder="Enter the title of the income"
        />
        <InputField
          title="Source:"
